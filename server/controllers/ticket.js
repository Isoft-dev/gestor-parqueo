...
function businessStatus(err) {
  ...
  if (/requerid|tipo de cobro|NIT|CF|COB_NIT|columna|monto recibido|MAQ_ID|comprobante|fk|ORA-02291|ORA-01400|UK_PAR_TICKET_COB_ID|FK_PAR_TICKET_COBRO/i.test(msg)) return 400;
