...
function businessStatus(err) {
  ...
  if (/requerid|tipo de cobro|tipo entrada|tipo salida|tipo cobro|NIT|CF|COB_NIT|columna|monto recibido|MAQ_ID|MOD_ID|COL_ID|placa|comprobante|validado|vencid|fk|ORA-02291|ORA-01400|UK_PAR_COBRO_TIC_ID|FK_PAR_COBRO_TICKET/i.test(msg)) return 400;
