...
export async function create(data) {
  await executeProcedure(`BEGIN SP_TARIFA_CREATE(:TAR_ID, :TAR_TIPO, :TAR_PRECIO); END;`, {
    TAR_ID: data.TAR_ID ?? null,
    TAR_TIPO: data.TAR_TIPO ?? null,
    TAR_PRECIO: data.TAR_PRECIO ?? null,
  });
  return getById(data.TAR_ID);
}

export async function update(id, data) {
  await executeProcedure(`BEGIN SP_TARIFA_UPDATE(:id, :TAR_TIPO, :TAR_PRECIO); END;`, {
    id,
    TAR_TIPO: data.TAR_TIPO ?? null,
    TAR_PRECIO: data.TAR_PRECIO ?? null,
  });
